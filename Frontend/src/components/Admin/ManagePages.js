  ...
  useEffect(() => {
    axios
      ...
      .catch(error => {
        ...
        toast.error('Error fetching pages'); // Show error toast
      });
  }, [websiteId]);
  ...
  const addPage = (event) => {
    ...
    axios
      ...
      .then(response => {
        ...
        toast.success('Page added successfully!'); // Show success toast
        setPageName('');
        setHtmlFileName('');
        setHtmlContent('');
        setCssFileName('');
      ...
      .catch(error => {
        ...
        toast.error('Error adding page'); // Show error toast
      });
  };
    ...
    if (window.confirm('Are you sure you want to delete this page?')) {
      axios
        ...
        .then(() => {
          ...
          toast.success('Page deleted successfully'); // Show success toast
        })
        .catch(error => {
          console.error('Error deleting page:', error);
          toast.error('Error deleting page'); // Show error toast
        });
    }
  };
